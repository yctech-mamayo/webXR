...
1. 錯字修改: Elephant, Dinosaur, 兼顧, 「請同意此網頁使用您的動作感應器」
2. 步驟文案替換:
    天鵝: 刪除逗號讓字不要到第二行: 已處理，提醒此會因為裝置大小有所不同。
    大象: 「第二層蓋四面」、扣、
    恐龍: 「加上手和尾巴，橫向吸一片更穩固」、
    鐘樓: all
...
首頁修改:
    header footer 文字色碼: #42bed4
    內文色碼深灰色: #4c4a4a
    背景鵝黃淺色 色碼: #feeebd

    © 2025 Mamayo 媽媽友. 版權所有．禁止未經授權使用。 done

* 圈起來兩邊文字的px希望可以再縮減2px 讓他看起來字體不會太大
