...
//[start-20191105-fei0079-mod]//
  tick: function tick(t, dt) {
    ...
    // if (this.mixer && !isNaN(dt) && this.model.animationSlices[0].uid != -1 ){
    if (this.mixer && !isNaN(dt) && Array.isArray( this.model.animationSlices ) && this.model.animationSlices[0] && this.model.animationSlices[0].uid != -1 ){
      this.mixer.update(dt / 1000);

      if (!this.mixer._actions[0] ){
        // console.log("aframe-extras.js: _actions[0] not exit, this=", this);
        return;
      }else{
        // console.log("aframe-extras.js: _actions[0] do exit, this=", this);
      }
          ...
          if (this.model.animationSlices[index]){
            ...
            if (this.mixer._actions[0].time > this.model.animationSlices[index].endTime){
              ...
              if(this.model.animationSlices[0].uid == this.model.animationSlices[0].loop){
                this.mixer._actions[0].time = this.model.animationSlices[index].startTime;
              }else if (this.model.animationSlices[0].reset){
                this.model.animationSlices[0].uid = this.model.animationSlices[0].idle;
                this.model.animationSlices[0].loop = this.model.animationSlices[0].idle;
                for(let i=1;i<this.model.animationSlices.length;i++){
                  if(this.model.animationSlices[0].uid == this.model.animationSlices[i].uid){
                    index = i
              ...
              this.model.animationSlices[0].count = 1;
