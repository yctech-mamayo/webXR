                    ...
                    steps:[
                        {
                            ...
                            obj_id: 'obj_1',
                            show_objs: [
                                { obj_id: 'obj_1', name: '1', type: 'flyin'},
                                { obj_id: 'obj_1', name: '2', type: 'flyin'},
                                { obj_id: 'obj_1', name: '4', type: 'flyin'},
                                { obj_id: 'obj_1', name: '5', type: 'flyin'},

                                { obj_id: 'obj_1', name: '6', type: 'flyin'},
                                { obj_id: 'obj_1', name: '7', type: 'flyin'},
                                { obj_id: 'obj_1', name: '8', type: 'flyin'},
                                { obj_id: 'obj_1', name: '9', type: 'flyin'},
